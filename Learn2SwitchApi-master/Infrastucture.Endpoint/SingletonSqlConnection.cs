...
namespace Infrastucture.Endpoint
{
    public class SingletonSqlConnection:ISingletonSqlConnection
    {
        ...
        {
            string connectionString = "Data Source = DAVE\\SQLEXPRESS; Initial Catalog = Learn2switch; Persist Security Info = False; Integrated Security = true;TrustServerCertificate=True";
